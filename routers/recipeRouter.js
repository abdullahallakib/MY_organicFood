...
const RecipeControl = require("../controllers/RecipeControl");
...
Router.route("/").get(RecipeControl.getallRecipe);
// Router
...
Router.route("/tour-stats").get(RecipeControl.getRecipeStats);
